...
####### do not change these values #######
  ...
  echo 'export PIB_PAT="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"'
  ...
  echo "export PIB_IS_INNER_LOOP=true"
  echo 'export PIB_FQDN=innerloop-kms1'
  echo 'export PIB_NO_SETUP=false'
  echo 'export PIB_REPO=kubernetes101/pib-dev'
  echo 'export PIB_BRANCH=kev-ms'
  echo 'export PIB_CLUSTER=innerloop-kms1'
  echo 'export PIB_ARC_ENABLED=false'
  echo 'export PIB_OSM_ENABLED=false'
  echo 'export PIB_DAPR_ENABLED=false'
  echo 'export PIB_RESOURCE_GROUP=pib-devbox-project-innerloop-test'
  echo 'export PIB_SSL='
